package com.worknector.offizz.database.course.application.usecase;

import com.worknector.offizz.database.course.application.dto.CourseResponse;
import com.worknector.offizz.database.course.application.dto.CourseResponse.Item;
import com.worknector.offizz.database.course.application.dto.CourseResponse.Items;
import com.worknector.offizz.database.course.application.mapper.CourseMapper;
import com.worknector.offizz.database.course.domain.entity.Course;
import com.worknector.offizz.database.course.domain.repository.CourseRepository;
