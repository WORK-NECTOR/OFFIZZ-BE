...
public class RestaurantRecommendController {
    ...
    public ResponseEntity<PagingRestaurantRecommend> searchRestaurant(@PathVariable(name = "page") int page,
                                                                      @PathVariable(name = "size") int size,
                                                                      @RequestParam(name = "search") String search,
                                                                      @RequestParam(name = "lat") double lat,
                                                                      @RequestParam(name = "lon") double lon) {
        PagingRestaurantRecommend allSearchOffice = restaurantRecommendUseCase.searchRecommendRestaurant(search, page, size, lat, lon);
